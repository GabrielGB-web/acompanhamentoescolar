      ...
      <div className="animate-fade-in space-y-6">
        ...
        {isLoading ? (
          ...
          <div className="text-center text-muted-foreground py-8">
            {searchTerm ? "Nenhum aluno encontrado" : "Nenhum aluno cadastrado. Clique em 'Novo Aluno' para começar."}
          </div>
        ) : (
      ...
      <AlertDialog open={!!deletingId} onOpenChange={() => setDeletingId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta ação não pode ser desfeita. O aluno será permanentemente excluído.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
